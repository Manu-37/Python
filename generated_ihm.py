...
from sqlalchemy import BigInteger, Boolean, Column, DateTime, ForeignKeyConstraint, Index, Integer, PrimaryKeyConstraint, String, Table, UniqueConstraint, text
...
t_v_col = Table(
    'v_col', Base.metadata,
    Column('db_id', BigInteger),
    Column('db_code', String(32)),
    Column('rel_nom', String(128)),
    Column('col_id', BigInteger),
    Column('col_nom', String(128)),
    Column('col_largeur', Integer),
    Column('col_actif', Boolean),
    Column('taf_code', String(32)),
    Column('lan_id', BigInteger),
    Column('lco_label', String(128)),
    Column('lco_label_court', String(15)),
    Column('lco_tooltip', String(512)),
    schema='ihm'
)
...
class TDbDb(Base):
    ...
    bas: Mapped[Optional['TBaseBas']] = relationship('TBaseBas', back_populates='t_db_db')
    env: Mapped[Optional['TEnvironnementEnv']] = relationship('TEnvironnementEnv', back_populates='t_db_db')
