...
# UI CTk — optionnel, customtkinter pas forcément installé
try:
...
# UI Qt — optionnel, PyQt6 pas forcément installé
try:
    from .ui import QtListeVue, QtFicheVue, QtControleur, QtTheme
except ImportError:
    pass
